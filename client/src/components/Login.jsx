    ...
    <div className="h-screen md:flex">
      ...
      <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form onSubmit={handleLogin} className="bg-white w-full max-w-md p-8 rounded-lg shadow-md">
          ...
          <p className="text-sm font-normal text-gray-600 mb-7">Welcome to ComicCon - India's Largest Comic Store</p>

          {/* Email Field */}
          <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
              <path d="M2.003 5.884l8 4.882 8-4.882A2 2 0 0016.743 4H3.257a2 2 0 00-1.254.884z" />
              <path d="M18 8.118l-8 4.882-8-4.882V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
            </svg>
            <input className="pl-2 outline-none border-none w-full" type="email" name="email" placeholder="Email Address" required />
          </div>
          ...
          {/* Submit Button */}
          <button type="submit" className="block w-full border-black border-2 bg-yellow-400 text-black py-2 font-semibold mb-2 hover:bg-yellow-400 transition duration-300">
            Login
          </button>
          ...
          <p className="text-sm mt-4 text-center text-gray-600">
            New to ComicCon?{' '}
            <Link to="/signup" className="text-yellow-500 hover:underline font-bold">
              Create an Account
            </Link>
          </p>
        </form>
